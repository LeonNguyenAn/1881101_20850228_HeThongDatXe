...
class CommonMethods
{
  checkConnectivity(BuildContext context) async
  {
    ...
    if (connectionResult != ConnectivityResult.mobile && connectionResult != ConnectivityResult.wifi)
    {
      ...
      displaySnackBar("Không có mạng internet. Kiểm tra lại  mạng và thử lại.", context);
    }
  }
  ...
  {
    double distancePerKmAmount = 1500;
    double durationPerMinuteAmount = 0.3;
    double baseFareAmount = 2;

    double totalDistanceTravelFareAmount = (directionDetails.distanceValueDigits! / 1) * distancePerKmAmount;
